  ...
  return (
    <div className="relative w-full">
      ...
      <motion.div 
        ...
        className="relative z-[2] flex w-full py-6 mt-[134px] mb-[132px] flex-col justify-center items-center gap-3 [background:rgba(227,45,45,0.12)] backdrop-blur-[5px] border-y-black border-t border-solid border-b"
      >
        <div className="sci-container text-center text-[#E32D2D] text-[32px] font-bold leading-[160%] tracking-[2px]">
