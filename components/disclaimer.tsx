export const Disclaimer = () => {
    return (
        <div className="flex w-full flex-col gap-2 justify-center [background:rgba(227,45,45,0.12)] backdrop-blur px-60 py-6 border-y-black border-t border-solid border-b mb-[48px]">
