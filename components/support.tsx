...
const Support = () => {
  return (
    <div className="sci-container relative flex flex-col w-full items-center z-[2] mb-[132px]">
      ...
      <div className="flex flex-col mt-[60px] gap-[24px] lg:gap-[44px] lg:flex-row gap-11 [background:rgba(255,255,255,0.12)] backdrop-blur-[20px] p-6 lg:p-12 rounded-3xl">
        ...
        <div className="flex flex-col gap-4 flex-1">
          <div className="text-white [font-family:'SF_Mono'] text-[32px] font-bold leading-[160%]">
            BREAKING!
          </div>
          <div className="text-white text-xl font-normal leading-[160%]">
            $scihub meme token is now officially listed on the Sci-Hub website!
          </div>
          <div className="text-[#A5A5A5] text-sm font-normal leading-[160%] py-[20px]">
            Nov 20, 2024
          </div>
          <motion.button
